...
export default {
    createGuestReceipt: async function(newGuestReceipt: NewGuestReceipt, guestReceiptDetailList: NewGuestReceiptDetail[]) {
        try {
            ...
            console.log("🚀 ~ file: purchases.model.ts:54 ~ createGuestReceipt:function ~ err:", err)
            return {
                status: false,
                message: "Lỗi model createGuestReceipt!",
                data: null
            }
        }
    },
    findGuestReceipt: async function(guestEmail: string) {
        try {
            ...
            return {
                status: false,
                message: "Lỗi model purchase findGuestReceipt!",
                data: null
            }
        }
    },
